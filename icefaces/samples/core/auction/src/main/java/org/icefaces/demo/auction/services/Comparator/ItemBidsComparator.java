...
public class ItemBidsComparator extends AbstractItemComparator {
    ...
    public ItemBidsComparator(boolean ascending) {
        super(ascending);
    }
    ...
    public int compare(AuctionItem o1, AuctionItem o2) {
        if (isAscending) {
            return Integer.valueOf(o1.getBids()).compareTo(o2.getBids());
        } else {
            return Integer.valueOf(o2.getBids()).compareTo(o1.getBids());
        }
    }
}
